...
import { setCommitStatus } from "../src/utils/set-commit-status";
import { getStatusForJob } from "../src/utils/get-status-for-job";
...
describe("setCommitStatus", () => {
  ...
  it("should set pending status in main stage", async () => {
    ...
    (
      mockOctokit.rest.actions.listJobsForWorkflowRun as unknown as jest.Mock<
